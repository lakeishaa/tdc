...
function setup() {
  ...
  STAR_ROWS.forEach(rowText => {
    const rowDiv = createDiv(rowText);
    rowDiv.parent(starWrapper);
  });
...
function draw() {
  ...
  // Mic B → Script B (vertical columns, endless downward)
